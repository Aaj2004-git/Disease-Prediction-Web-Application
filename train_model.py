...
# List of symptoms as in your Django code
symptoms = [
...
for disease in diseases:
    for _ in range(3):  # 3 samples per disease
        row = np.random.randint(0, 2, len(symptoms)).tolist()
        data.append(row + [disease])
...
print('Model trained and saved to trained_model/model.pkl')
